...
1、手柄解码，识别按键值，读取模拟值。       
**********************************************************/	 
#define DI   PAin(0)           //PB12  输入

#define DO_H PEout(6)=1        //命令位高
#define DO_L PEout(6)=0        //命令位低

#define CS_H PEout(4)=1       //CS拉高
#define CS_L PEout(4)=0       //CS拉低

#define CLK_H PEout(2)=1      //时钟拉高
#define CLK_L PEout(2)=0      //时钟拉低
