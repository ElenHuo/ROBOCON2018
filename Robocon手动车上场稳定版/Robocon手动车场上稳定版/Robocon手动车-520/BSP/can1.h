...
void TAKEBALL_TASK(void);
void RELAY_TASK(void);
void takeball_init(void);
void Take_Motor_Init(void);
void CAN1_REMOTE_CHECK(void);


extern uint8_t Init_flag;
extern float Speed_Relay;
extern float speed;
extern uint16_t take_shreshold;
extern long takeball_position;
extern long target_position;
extern long relay_position;
extern long relay_target_position;
extern long offset_position;
